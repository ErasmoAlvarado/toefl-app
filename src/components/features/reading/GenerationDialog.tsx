...
export function GenerationDialog({ isOpen, onClose, onGenerate, isGenerating }: GenerationDialogProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-card w-full max-w-lg rounded-2xl shadow-xl border border-border p-6 relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <p className="text-muted-foreground text-sm mb-6">
          Tailor the AI-generated reading passage to focus on specific topics or adapt to your preferred difficulty level. Leave options as "Random" for a surprise!
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              type="text"
              placeholder="e.g. Photosynthesis, Modern Architecture..."
          ...
          {/* Format */}
          <div className="space-y-2">
            <label className="text-sm font-semibold text-foreground">Passage Format (TOEFL 2026)</label>
            <select
              value={passageType}
            ...
            >
              ...
              <option value="academic">Academic Reading (~700 words)</option>
              <option value="daily_life">Read in Daily Life (~350 words)</option>
            </select>
          </div>
