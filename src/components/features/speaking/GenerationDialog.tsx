    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-card w-full max-w-lg rounded-2xl shadow-xl border border-border p-6 relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <p className="text-muted-foreground text-sm mb-6">
          Tailor the AI-generated speaking material to focus on specific topics, task types, or adjust the difficulty level. Leave options as "Random" for a surprise!
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              type="text"
              placeholder="e.g. University Policies, Biology, History..."
          ...
          {/* Format */}
          <div className="space-y-2">
            <label className="text-sm font-semibold text-foreground">Speaking Task Type</label>
            <select
              value={taskType}
            ...
            >
              ...
              <option value="listen_and_repeat">Task 1 (Listen & Repeat)</option>
              <option value="interview">Task 2 (Simulated Interview)</option>
            </select>
          </div>
