...
export function GenerationDialog({ isOpen, onClose, onGenerate, isGenerating }: GenerationDialogProps) {
  ...
  const [listeningType, setListeningType] = useState("random");
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-card w-full max-w-lg rounded-2xl shadow-xl border border-border p-6 relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <p className="text-muted-foreground text-sm mb-6">
          Tailor the AI-generated listening material to focus on specific topics, formats, or adjust to your preferred difficulty level. Leave options as "Random" for a surprise!
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              type="text"
              placeholder="e.g. History of Rome, Introduction to Biology..."
          ...
          {/* Format */}
          <div className="space-y-2">
            <label className="text-sm font-semibold text-foreground">Listening Format</label>
            <select
              value={listeningType}
